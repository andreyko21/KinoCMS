...
export default {
  ...
  methods: {
    ...
    async DeleteFile (fileName) {
      ...
      await this.cloudFirestore.DeleteDocument(promotionsEnCollectionRef, fileName)
      await this.cloudFirestore.DeleteDocument(promotionsUaCollectionRef, fileName)
      this.GetList()
    ...
    async GetList () {
      try {
        this.isLoading = true
        const result = await this.cloudFirestore.GetAllDocuments(promotionsEnCollectionRef)
