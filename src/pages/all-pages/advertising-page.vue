<template>
  <card :title="title" :isLoading="isLoading">
    ...
    <template #body>
      <advertising-form v-model="currentLanguage.data"> </advertising-form>
...
import AdvertisingForm from '@/components/all-pages/advertising-form.vue'
export default {
  components: { card, LanguageComponent, checkboxComponent, AdvertisingForm },
  setup () {
