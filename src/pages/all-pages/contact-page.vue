<template>
  <card :title="title" :isLoading="isLoading">
    ...
    <template #body>
      <contact-form v-model="currentLanguage.data"> </contact-form>
...
import contactForm from '@/components/all-pages/contacts/contact-form.vue'
export default {
  components: { card, LanguageComponent, checkboxComponent, contactForm },
  setup () {
      ...
      languages: [
        {
          ...
          data: {
            cinemaList: [
              { id: 0, name: '', address: '', coordinates: '', logoImg: {}, deleteImgList: [] },
              { id: 1, name: '', address: '', coordinates: '', logoImg: {}, deleteImgList: [] },
              { id: 2, name: '', address: '', coordinates: '', logoImg: {}, deleteImgList: [] }
            ],
            seo: {},
            deleteImgList: []
          }
        },
        {
          ...
          data: {
            cinemaList: [
              { id: 0, name: '', address: '', coordinats: '', logoImg: {}, deleteImgList: [] },
              { id: 1, name: '', address: '', coordinates: '', logoImg: {}, deleteImgList: [] },
              { id: 2, name: '', address: '', coordinates: '', logoImg: {}, deleteImgList: [] }
            ],
            seo: {},
