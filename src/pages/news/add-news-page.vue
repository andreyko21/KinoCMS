<template>
  <card :title="title" :isLoading="isLoading">
    ...
    <template #body>
      <add-news-form v-model="currentLanguage.data"> </add-news-form>
...
import addNewsForm from '@/components/news-page/add-news-form.vue'
...
export default {
  components: { card, addNewsForm, LanguageComponent, checkboxComponent },
  setup () {
      ...
      languages: [
        {
          ...
          name: 'Українська',
          abbreviation: 'Ua',
          collection: newsUaCollectionRef,
          checked: false,
          data: {
            name: '',
            datePublication: '',
        ...
        },
        {
          ...
          name: 'Англійська',
          abbreviation: 'En',
          collection: newsEnCollectionRef,
          checked: true,
          data: {
            name: '',
            datePublication: '',
  ...
  methods: {
    ...
    async ResetNews () {
      this.isLoading = true
      await this.GetNews(this.currentLanguage)
